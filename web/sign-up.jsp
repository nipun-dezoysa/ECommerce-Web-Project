...
<body>
  <div class="flex h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-5" action="SignUpServlet" method="post">
        <div>
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        ...
        <a href="sign-in.jsp" class="font-semibold leading-6 text-primary hover:text-primaryLight">Sign In Here</a>
      </p>
    </div>
  </div>

<%-- 
    Document   : checkout
    Created on : Mar 31, 2024, 9:18:45 AM
    Author     : samee
--%>
...
<jsp:include page="./WEB-INF/components/nav.jsp" />
    ...
    <div class="flex flex-col md:flex-row shadow-md my-10">
        <div class="w-full md:w-3/4 bg-white px-10 py-10">
            ...
            <div class="md:flex items-stretch py-8 md:py-10 lg:py-8 border-t border-gray-50">
                ...
                <div class="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
                    ...
                    <div class="flex items-center justify-between pt-5">
                        ...
                        <p class="text-base font-black leading-none text-gray-800">5000</p>
                    </div>
                </div>
            </div>
           ...
           <a href="hero.jsp" class="flex font-semibold text-black text-sm mt-10">
    ...
    Continue Shopping
        ...
        <div id="summary" class="w-full md:w-1/4 px-8 py-10">
            ...
            <button class="bg-black hover:bg-gray-900 px-5 py-2 text-sm text-white uppercase">
                Apply
            </button>
            <div class="border-t mt-8">
                ...
                <a href="checkout.jsp">
                    <button class="bg-black hover:bg-gray-900 font-semibold py-3 text-sm text-white uppercase w-full">
                    Checkout
                </button>  
                </a>
